                    ...
                    <form id="demo-form2" data-parsley-validate="" class="form-horizontal form-label-left" novalidate="" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea name="import" lass="form-control col-md-7 col-xs-12" id="" style="width: 100%;" rows="10" placeholder="#EXTINF:0,NAMEOFSTREAM1&#10http://url1.com:8000/nameofstream1&#10#EXTINF:0,NAMEOFSTREAM2&#10http://url2.com:8000/nameofstream2&#10#EXTINF:0,NAMEOFSTREAM3&#10http://url3.com:8000/nameofstream3&#10"></textarea>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Proxy (restream) streams:</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">BitStream filter:</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
